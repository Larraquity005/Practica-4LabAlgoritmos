...
divideLoop:
    ...
    add     edx, 48         ; convert edx to its ASCII representation - remainder of division
...
iprintLF:
    ...
    mov     eax, 0Ah        ; move 0Ah into eax - ASCII linefeed
    push    eax             ; push the linefeed onto the stack
    mov     eax, esp        ; move stack pointer into eax for sprint
    call    sprint          ; call our sprint function
    pop     eax             ; remove linefeed character from the stack
